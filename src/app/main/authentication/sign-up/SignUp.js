      ...
      >
        ...
        <div className="z-10 relative w-full max-w-2xl">
          <div className="text-7xl font-bold leading-none text-gray-100">
            <div>Dos pequenos detalhes ao panorama completo.</div>
          </div>
          <div className="mt-24 text-lg tracking-tight leading-6 text-white">
            Organize e atribua suas tarefas em um único espaço compartilhado e tenha uma visão geral
            de sua agenda.
          </div>
          <div className="flex items-center mt-32">
            ...
            >
              <Avatar src="assets/images/avatars/female-14.jpg" />
              <Avatar src="assets/images/avatars/male-16.jpg" />
              <Avatar src="assets/images/avatars/female-15.jpg" />
